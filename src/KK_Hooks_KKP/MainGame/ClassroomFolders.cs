...
namespace BrowserFolders.Hooks.KKP
{
    public class ClassroomFolders : BaseFolderBrowser
    {
        ...
        internal static void Init(PreviewCharaList list, int sex)
        {
            if (_customCharaFile != list && _folderTreeView != null)
            {
        ...
        {
            return EnableClassroom.Value && _customCharaFile != null && _customCharaFile.isVisible && _targetScene == Scene.Instance.AddSceneName ? 1 : 0;
        }
