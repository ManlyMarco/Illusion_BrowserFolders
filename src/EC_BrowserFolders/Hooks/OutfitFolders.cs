...
{
    [BrowserType(BrowserType.Outfit)]
    public class OutfitFolders : IFolderBrowser
    {
 
        private static HEdit.PartInfoClothSetUI _partInfoClothSetUI;
        ...
        public OutfitFolders()
        {
            ...
            HarmonyWrapper.PatchAll(typeof(OutfitFolders));
        ...
        [HarmonyPrefix]
            [HarmonyPatch(typeof(HEdit.PartInfoClothSetUI), "Start")]
        [Obsolete]
        internal static void InitHook(HEdit.PartInfoClothSetUI __instance)
            {
        ...
        [HarmonyTranspiler]
            [HarmonyPatch(typeof(HEdit.PartInfoClothSetUI), "OpenItemCategory")]
        ...
        public void OnGui()
        {
            ...
            if (_partInfoClothSetUI != null && _loadOutfitToggle.activeSelf && _targetScene == Scene.Instance.AddSceneName)
            {
                        ...
                        var screenRect = new Rect((int)(Screen.width * 0.344), (int)(Screen.height * 0.57f), (int)(Screen.width * 0.125), (int)(Screen.height * 0.35));
