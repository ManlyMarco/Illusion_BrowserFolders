...
{
    [BrowserType(BrowserType.MakerPose)]
    public class MakerPoseFolders : IFolderBrowser
    {


        private static Pose.PoseLoadScene _poseLoadScene;
        ...
        public MakerPoseFolders()
        {
            ...
            HarmonyWrapper.PatchAll(typeof(MakerPoseFolders));
        ...
        [HarmonyPrefix]
        [HarmonyPatch(typeof(Pose.PoseLoadScene), "Awake")]
        internal static void InitHook(Pose.PoseLoadScene __instance)
        ...
        [HarmonyTranspiler]
        [HarmonyPatch(typeof(Pose.PoseLoadScene), "CreateList")]
