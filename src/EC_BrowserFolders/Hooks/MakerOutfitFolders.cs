    ...
    public class MakerOutfitFolders : IFolderBrowser
    {
        ...
        [HarmonyPrefix]
            ...
            internal static void InitHook(CustomCoordinateFile __instance)
            {
                ...
                _folderTreeView.DefaultPath = Path.Combine((UserData.Path), instance.chaCtrl.sex != 0 ? @"coordinate/female" : "coordinate/male");
        ...
        internal static IEnumerable<CodeInstruction> InitializePatch(IEnumerable<CodeInstruction> instructions)
        {
            foreach (var instruction in instructions)
            {
                ...
                if (instruction.opcode == OpCodes.Ldelem_Ref)
                {
                    ...
                    yield return new CodeInstruction(OpCodes.Ldsfld, typeof(MakerHPoseIKFolders).GetField(nameof(_currentRelativeFolder), BindingFlags.NonPublic | BindingFlags.Static));
                }
            }
        }
