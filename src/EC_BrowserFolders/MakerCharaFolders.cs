...
namespace BrowserFolders
{
    public class MakerCharaFolders : BaseFolderBrowser
    {
        ...
        public MakerCharaFolders() : base("Character folder", Utils.NormalizePath(UserData.Path), Utils.NormalizePath(UserData.Path)) { }

        protected override bool OnInitialize(bool isStudio, ConfigFile config, Harmony harmony)
        {
            var enable = config.Bind("Enable folder browser for", "Characters", true, "Changes take effect on game restart");
